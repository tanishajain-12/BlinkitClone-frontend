...
export default function LoginPage({ onNavigate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // ── Hit the backend via AuthContext ────────────────────────────────────
    const result =
      mode === "login"
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 px-8 py-8 relative overflow-hidden">
            ...
            <div className="relative">
              <button onClick={() => onNavigate("home")} className="flex items-center gap-1.5 mb-5">
          ...
          <div className="px-8 py-6">
              ...
              {mode === "signup" && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all disabled:opacity-60"
                  />
                </div>
              )}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    disabled={authLoading}
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 pr-11 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all disabled:opacity-60"
                  />
                  <button
                    type="button"
            ...
            <p className="text-xs text-gray-400 text-center mt-5 leading-relaxed">
              ...
              <button type="button" className="text-gray-600 font-semibold hover:underline">Terms of Service</button>
              {" & "}
              <button type="button" className="text-gray-600 font-semibold hover:underline">Privacy Policy</button>
            </p>
          </div>
        </div>
